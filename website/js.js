$("document").ready(function() {
	...
	$("#scrollmenu").hover(function(){  //Deze functie is toegevoegd om de navbar tevoorschijn te laten komen
		...
		if ($(window).width() > 900) {
			...
			$('#scrollmenu').animate({
				opacity: 0.5, top: '-30px' }, 250);
		}
	});
	
	$("#menuimg").click(function(){  //Deze functie is toegevoegd om de navbar tevoorschijn te laten komen
...
//	});
	...
	$("#rightbutton3").click(function(){
        ...
        if ($('#content3-1').is(":visible"))  {
            $('#content3-1').fadeTo('slow', 0);
            $('#content3-1').hide();
			$('#leftbutton3').show();
			$('#leftbutton3').fadeTo('slow', 1);
            $('#content3-2').show();
            $('#content3-2').fadeTo('slow', 1);
        }

        else if ($('#content3-2').is(":visible"))  {
            $('#content3-2').fadeTo('slow', 0);
            $('#content3-2').hide();
			$('#rightbutton3').fadeTo('slow', 0);
            $('#rightbutton3').hide();
            $('#content3-3').show();
            $('#content3-3').fadeTo('slow', 1);
        }
    ...
    $("#leftbutton3").click(function(){
        ...
        if ($('#content3-2').is(":visible"))  {
            $('#content3-2').fadeTo('slow', 0);
            $('#content3-2').hide();
			$('#leftbutton3').fadeTo('slow', 0);
            $('#leftbutton3').hide();
            $('#content3-1').show();
            $('#content3-1').fadeTo('slow', 1);
        }

        else if ($('#content3-3').is(":visible"))  {
            $('#content3-3').fadeTo('slow', 0);
            $('#content3-3').hide();
			$('#rightbutton3').show();
			$('#rightbutton3').fadeTo('slow', 1);
            $('#content3-2').show();
            $('#content3-2').fadeTo('slow', 1);
        }
    });
